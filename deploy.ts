...
class Demo {
  ...
  public propose() {
    ...
    Web3.eth.accounts.signTransaction({
      from: '0xc300195A5a48Ae53B317DDF90823ee749A027390',
      gas: web3.utils.toHex(300000),
      gasPrice: web3.utils.toWei('4', 'Gwei'),
      to: '0x0000000000000000000000000000000000000088',
      value: '10000000000000000000000000',
      data: data,
    }, '0x5f15e172b9cf59089739bd2c2b2001897a5e05608cd68419af578eedf6579dfd').then((result) => {
      console.log(result);
  ...
  public uploadKYC() {
    ...
    Web3.eth.accounts.signTransaction({
      from: '0xD33DB4D88A1d51c918A2D4e23135225952038e7b',
      gas: web3.utils.toHex(300000),
      gasPrice: web3.utils.toWei('4', 'Gwei'),
      to: '0x0000000000000000000000000000000000000088',
      data: data,
    }, '0xfba37211f57258dc455d4643af07da640756caa85c2b1afeeea500c7c3ba5c96').then((result) => {
      console.log(result);
      Web3.eth.sendSignedTransaction(result.rawTransaction)
      .on('transactionHash', (hash: String) => {
        console.log(`txHash`, hash);
